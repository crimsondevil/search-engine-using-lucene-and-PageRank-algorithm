...
<html>
    ...
    <body>
        ...
        <center><h2> FoxNews Ranking Algorithm Comparison with AutoComplete and Spell Checking </h2></center>
        <form accept-charset="utf-8" method="get">
            <center>
                ...
                ?> > Lucene
                <input type="radio" name="search_algo" value="page_rank"
                <?php
        ...
        <?php
	        if ($flag == true)
	        {
		        echo "<br /><center><div style='padding-top:10px'>Did you mean: <a href='?q=" . $corrected_term . "&search_algo=" . $_REQUEST['search_algo'] . "'>" . $corrected_term . "</a><br /></div></center>";
	        }
        ?>
    </body>
</html>